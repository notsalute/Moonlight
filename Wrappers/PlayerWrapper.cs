...
namespace Moonlight_Client.SDK
{
    static class PlayerWrapper
    {
        ...
        //public static APIUser GetSelectedUser(this SelectedUserMenuQM selectMenu) => selectMenu;
        ...
        {
            MonoBehaviour1PublicObReObBoVeBoGaVeStBoUnique component = GameObject.Find("Screens").transform.Find("Avatar").GetComponent<MonoBehaviour1PublicObReObBoVeBoGaVeStBoUnique>();
            component.field_Public_MonoBehaviourPublicSiGaRuGaAcRu4StAvObUnique_0.field_Internal_ApiAvatar_0 = new ApiAvatar { id = AvatarID };
